...
= 0.22.1 =
* **New — App editing, and it is off until you turn it on:** Settings → Bynli Connect → Connection now shows an **App editing** card. Switching it on lets you design this site from the Bynefit app — and while it is on, Bynefit can change this site's pages and design on your behalf. Only an administrator can switch it on, nothing on your site changes until someone does, and the same card switches it back off at any time. We are calling this out rather than listing it as a feature because it grants us write access to your site: you should know the control appeared even if you never use it.
