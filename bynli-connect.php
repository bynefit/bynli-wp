 ...
 * Description:       Connect a WordPress site to Bynli — reports daily usage to the platform and (later) exposes Bynli shortcodes for forms, events, and donations.
 * Version:           0.1.0
...
define('BYNLI_CONNECT_VERSION', '0.1.0');
